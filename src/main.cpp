...
uint256 hashGenesisBlock("0xf2dd6d312706aeba4c92356b41ef0f65952e1a8e7594141d468852002c3a9cb0");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 100000 blocks, which will occur approximately every 6 months
    nSubsidy >>= (nHeight / 100000); // Lovecoin: 100k blocks in ~6 months
...
static const int64 nTargetTimespan = 60 * 60; // Lovecoin: 1 hour
static const int64 nTargetSpacing = 30; // Lovecoin: 30 seconds
static const int64 nInterval = nTargetTimespan / nTargetSpacing;

*/

static  int64 nTargetTimespan = 10 * 2.5 *  60; // Lovecoin: 1 hour
static  int64 nTargetSpacing = 2.5 * 60; // Lovecoin: 30 seconds
...
{
    // Lovecoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf2dd6d312706aeba4c92356b41ef0f65952e1a8e7594141d468852002c3a9cb0");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Yahoo News 02/Dec/2013 China launches first moon rover mission";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1385968234;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 385366862;
        ...
        assert(block.hashMerkleRoot == uint256("0x23442414cd9d034d1b3bd22a044debcd2cfdd6ebec9504668c88a672c3a75dbf"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Lovecoin: increase each by adding 2 to bitcoin's value.
